...
//   'Heading':'<h1>Form Heading</h1>',
  ...
  'Datepicker':'  <input type="date" id="Datepicker"  class="form-control">',

  'location':'<button id="location" onclick="getLocation()">Location</button>',
  'Image upload':'<input type="file" id="img"  accept="image/*" class="form-control">',
 'Radio':'<input type="radio" id="radio" class="form-control" > ',
 'Rate':'<i class="material-icons"  id="Rate" >&#xe838</i>',
   'dropdown':`<div class="dropdown">
   				<span class="mouse">Mouse hover me</span>
				   <div class="dropdown-content">
				   <p>drop down content will be shown here!</p>
				   </div>
				   </div>`,
